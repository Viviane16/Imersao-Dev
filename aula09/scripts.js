...
function atualizaPlacar() {
  ...
  //ao usar o div, 'placar' será reconhecido pois esse comando puxa termos direto do html;
...
function jogar() {
  ...
  atualizaPlacar() 
  // IMPORTANTE! Ótimo exemplo do que é uma função. O placar não estava sendo atualizado no final, ao CHAMAR a função acima o placar atualizou. Isso porque, isso é o que é uma função, você determinar e chamar uma determinada ação.
  exibeCartaMaquina()
  atualizaQuantidadeDeCartas()
}
